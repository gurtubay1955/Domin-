      ...
      <div className="flex flex-col items-center gap-8 relative z-10 w-full max-w-lg">
        ...
        <div className="flex flex-col items-center gap-4 opacity-30 text-xs text-center">
          ...
          <div className="flex gap-4">
            ...
            <button
              onClick={() => {
                if (confirm("☢️ ALERTA NUCLEAR ☢️\n¿Estás 100% seguro? Esto borrará el LocalStorage completo del navegador, eliminando CUALQUIER rastro de datos antiguos que se hayan quedado pegados.\n\nEs la solución definitiva si tienes 'partidas fantasma'.")) {
                  localStorage.clear();
                  sessionStorage.clear();
                  window.location.href = "/";
                }
              }}
              className="hover:text-red-600 font-bold text-red-500/50 hover:text-red-500 transition-colors cursor-pointer"
              title="Borrado de Emergencia (Si el reset normal falla)"
            >
              [ ☢️ NUCLEAR ]
            </button>
          </div>
